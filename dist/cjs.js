...
function getSchemaDump(connection, options, tables) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createStatements = (yield connection.multiQuery(getSchemaMultiQuery))
            ...
            if (isCreateView(res)) {
                return Object.assign(Object.assign({}, table), { name: res.View, schema: format$$1(res['Create View']), data: null, isView: true });
            }
            return Object.assign(Object.assign({}, table), { name: res.Table, schema: format$$1(res['Create Table']), data: null, isView: false });
        })
            .map(s => {
